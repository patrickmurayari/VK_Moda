                    ...
                    products.map((elem, index) => (
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-2 items-center justify-start w-full">
                                <h6 data-aos="zoom-in-up" data-aos-duration="1500"  className=" text-lg md:text-lg  font-extralight  text-center">{elem.name}</h6>
                                <div>
                                    <h3 data-aos="zoom-in-up" data-aos-duration="1500"  className="font-bold items-center flex justify-center ">
                                        {elem.precio}
                                    </h3>
                                </div>
                            </div>
