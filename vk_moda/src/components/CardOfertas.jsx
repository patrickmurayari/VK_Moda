        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-4 ">
            {products &&
                products.map((elem, index) => (
                    <div
                        key={index}
                        className=" flex flex-col items-center justify-center  bg-gray-800 w-full h-96 p-4 md:p-8  transition-transform transform-gpu hover:scale-125 hover:transition-transform duration-300"
                    >
                        <img
