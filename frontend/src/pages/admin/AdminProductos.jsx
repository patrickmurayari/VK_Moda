        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    ...
                    <p className="text-sm sm:text-base text-stone-500 mt-1">{productos.length} productos registrados</p>
                </div>
                <Link
                                            ...
                                            <div className="flex items-center gap-3">
                                                {producto.imagen_url && (
                                                    <img
                                                        ...
                                                        alt={producto.nombre}
                                                        className="w-10 h-10 sm:w-12 sm:h-12 object-cover rounded shrink-0 border border-stone-200"
                                                    />
                                                )}
