    ...
    return (
        <div className='p-4 md:p-12 bg-neutral-50 rounded-xl shadow-elegant mt-8 md:mt-12' id="contactos">
            <div className='max-w-4xl mx-auto'>
                ...
                <div className="w-16 h-px bg-neutral-300 mx-auto mb-12"></div>
                ...
                <div className="space-y-8 md:grid md:grid-cols-2 md:gap-10 md:items-start md:space-y-0">
                    ...
                    <div className='text-neutral-700 space-y-6 max-w-2xl mx-auto md:max-w-none md:mx-0'>
                        <div className='flex items-start gap-4 p-4 bg-white rounded-lg shadow-elegant hover:shadow-elegant-lg transition-shadow'>
                            <FiMapPin className='text-neutral-500 text-2xl mt-1 flex-shrink-0' />
                            <div>
                                ...
                                <a 
                                    ...
                                    className='text-neutral-600 hover:text-neutral-900 text-xs font-semibold mt-2 inline-block transition-colors'
                                >
                                    Ver en Google Maps →
                                </a>
                            </div>
                        ...
                        <div className='flex items-start gap-4 p-4 bg-white rounded-lg shadow-elegant hover:shadow-elegant-lg transition-shadow'>
                            <FiClock className='text-neutral-500 text-2xl mt-1 flex-shrink-0' />
                            <div>
                        ...
                        <div className='flex items-start gap-4 p-4 bg-white rounded-lg shadow-elegant hover:shadow-elegant-lg transition-shadow'>
                            <FiPhone className='text-neutral-500 text-2xl mt-1 flex-shrink-0' />
                            <div>
                                <p className='font-semibold text-primary-900 text-lg'>Llámanos:</p>
                                <a href="tel:+541126073801" className='text-neutral-700 hover:text-neutral-900 font-semibold mt-1 transition-colors'>
                                    (+54) 11 2607-3801
                                </a>
                            </div>
                        </div>
                        ...
                        <div className='flex items-start gap-4 p-4 bg-white rounded-lg shadow-elegant hover:shadow-elegant-lg transition-shadow'>
                            <FiMail className='text-neutral-500 text-2xl mt-1 flex-shrink-0' />
                            <div>
                                <p className='font-semibold text-primary-900 text-lg'>Escríbenos:</p>
                                <a href="mailto:murayarivirginia797@gmail.com" className='text-neutral-700 hover:text-neutral-900 font-semibold mt-1 transition-colors break-all'>
